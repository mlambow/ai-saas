...
export default async function LandingPage() {
    return (
        <div className='flex flex-col max-w-4xl mx-auto items-center justify-center space-y-6 h-screen w-screen'>
            ...
            <SignUpButton>
                <Button className='mx-auto mt-12 md:mt-10 text-3xl flex items-center justify-center dark:bg-primary/90 py-8 rounded-full cursor-pointer font-light dark:hover:bg-secondary-foreground dark:hover:text-black hover:bg-secondary-foreground' size='lg'>
